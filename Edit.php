...
include("dbconn.php");
 ...
 { 
    $obj=new Todo;
     $msg=$obj->edit($_POST['email'],$_POST['uname'],$_POST['name'],$_POST['age'],$_POST['city'],$_FILES['image']);
...
<?php
   ...
   ?>
    ...
    <div class="border border-success container mt-4 bg-dark text-light col-6"><br>
        <h2 align="center"><i class="text-info border border-info container col-6">EDIT PANEL</i></h2><br>
        <form method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="text-warning">Email</label>
                <input type="text" name="email" placeholder="email@gmail.com" class="form-control col-10" value="<?= $obj->email1;?>" >
            </div>
            <div class="form-group">
                <label class="text-warning">Username</label>
                <input type="text" name="uname" placeholder="enter @name" class="form-control col-10" value="<?php echo $obj->uname;?>">
            </div>
            <div class="form-group">
            ...
            <input type="submit" value="UPDATE" class="btn btn-success col-6" name="sub"><br><br>
    </div>
    </form>
    <br><br>
</body>
